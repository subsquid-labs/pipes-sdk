...
import { acquireDuckdbInstance } from '../../../packages/pipes/src/targets/parquet/duckdb/duckdb-engine.js'
import {
  DuckdbSegmentWriter,
  SegmentSizeEstimator,
} from '../../../packages/pipes/src/targets/parquet/duckdb/duckdb-writer.js'
import {
  buildRowWrapper,
  toParquetSchemaShape,
} from '../../../packages/pipes/src/targets/parquet/parquetjs/parquetjs-schema.js'
import { ParquetSegmentWriter } from '../../../packages/pipes/src/targets/parquet/parquetjs/parquetjs-writer.js'
import {
  type Codec,
  type ParquetColumns,
  type ParquetTable,
} from '../../../packages/pipes/src/targets/parquet/schema.js'
import type { SegmentWriter } from '../../../packages/pipes/src/targets/parquet/segment.js'
...
const SCHEMAS: Record<string, { table: ParquetTable; makeRow: (i: number) => Row }> = {
  ...
  // The production-motivating workload — same shape as bench-parquet.ts.
  btc_outputs: {
    table: {
      table: 'outputs',
      schema: {

...
export const events = {
  ...
  CollectProtocol: event(
    ...
    { sender: indexed(p.address), recipient: indexed(p.address), amount0: p.uint128, amount1: p.uint128 },
  ),
  Flash: event(
  ...
  Initialize: event('0x98636036cb66a9c19a37435efc1e90142190214e8abeb821bdba3f2990dd4c95', 'Initialize(uint160,int24)', {
  ...
  SetFeeProtocol: event(
    ...
    { feeProtocol0Old: p.uint8, feeProtocol1Old: p.uint8, feeProtocol0New: p.uint8, feeProtocol1New: p.uint8 },
  ),
  Swap: event(
...
export const functions = {
  ...
  flash: fun('0x490e6cbc', 'flash(address,uint256,uint256,bytes)', {
    recipient: p.address,
    amount0: p.uint256,
    amount1: p.uint256,
    data: p.bytes,
  }),
  increaseObservationCardinalityNext: fun('0x32148f67', 'increaseObservationCardinalityNext(uint16)', {
  ...
  mint: fun(
    ...
    { recipient: p.address, tickLower: p.int24, tickUpper: p.int24, amount: p.uint128, data: p.bytes },
    { amount0: p.uint256, amount1: p.uint256 },
  ),
  observations: viewFun(
    ...
    { _0: p.uint256 },
    {
      ...
      secondsPerLiquidityCumulativeX128: p.uint160,
      initialized: p.bool,
    },
  ),
  observe: viewFun(
  ...
  positions: viewFun(
    ...
    { _0: p.bytes32 },
    {
      ...
      tokensOwed0: p.uint128,
      tokensOwed1: p.uint128,
    },
  ),
  ...
  slot0: viewFun(
    ...
    {},
    {
      sqrtPriceX96: p.uint160,
      tick: p.int24,
      observationIndex: p.uint16,
      observationCardinality: p.uint16,
      observationCardinalityNext: p.uint16,
      feeProtocol: p.uint8,
      unlocked: p.bool,
    },
  ...
  snapshotCumulativesInside: viewFun(
    ...
    { tickCumulativeInside: p.int56, secondsPerLiquidityInsideX128: p.uint160, secondsInside: p.uint32 },
  ),
  swap: fun(
    '0x128acb08',
  ...
  ticks: viewFun(
    ...
    { _0: p.int24 },
    {
      ...
      feeGrowthOutside0X128: p.uint256,
      feeGrowthOutside1X128: p.uint256,
      tickCumulativeOutside: p.int56,
      secondsPerLiquidityOutsideX128: p.uint160,
      secondsOutside: p.uint32,
      initialized: p.bool,
    },
  ),
...
export type IncreaseObservationCardinalityNextParams = FunctionArguments<
  typeof functions.increaseObservationCardinalityNext
>
export type IncreaseObservationCardinalityNextReturn = FunctionReturn<
  typeof functions.increaseObservationCardinalityNext
>

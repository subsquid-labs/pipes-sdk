...
export const baseDependencies = ['@subsquid/pipes', '@subsquid/evm-codec', '@subsquid/evm-abi', 'dotenv']

export const baseDevDependencies = ['typescript', '@biomejs/biome', 'tsx', 'tsup', '@types/node']

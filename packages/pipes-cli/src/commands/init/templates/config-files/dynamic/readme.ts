...
This will start the Pipes UI dashboard at http://localhost:3000. _Learn more about Pipes UI [here](https://beta.docs.sqd.dev/en/sdk/pipes-sdk/evm.autogenerated/reference/pipe-ui)_
\`\`\`bash
